...
sap.ui.define(["sap/base/Log", "./OData", "./MetadataHandlerV2", "sap/ui/model/odata/v2/ODataListBinding"], function (Log, __OData, __MetadataHandlerV2, ODataListBinding) {
   ...
   */
  const ODataV2 = OData.extend("cc.spreadsheetimporter.v1_1_1.ODataV2", {
    constructor: function _constructor(spreadsheetUploadController) {
      OData.prototype.constructor.call(this, spreadsheetUploadController);
      this.createPromises = [];
      this.createContexts = [];
    ...
    getLabelList: async function _getLabelList(columns, odataType, excludeColumns, tableObject) {
