...
sap.ui.define(["sap/base/Log", "./MetadataHandler"], function (Log, __MetadataHandler) {
   ...
   */
  const MetadataHandlerV2 = MetadataHandler.extend("cc.spreadsheetimporter.v1_1_1.MetadataHandlerV2", {
    ...
    getLabelList: function _getLabelList(columns, odataType, odataEntityType, excludeColumns) {
