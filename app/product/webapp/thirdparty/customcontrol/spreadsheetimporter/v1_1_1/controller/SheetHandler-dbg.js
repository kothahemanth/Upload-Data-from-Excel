...
sap.ui.define(["sap/ui/base/ManagedObject", "cc/spreadsheetimporter/v1_1_1/thirdparty/xlsx"], function (ManagedObject, XLSX) {
  "use strict";

  /**
   * @namespace cc.spreadsheetimporter.v1_1_1
   */
  const SheetHandler = ManagedObject.extend("cc.spreadsheetimporter.v1_1_1.SheetHandler", {
