...
/// <reference path="dialog/OptionsDialog.d.ts" />
/// <reference path="odata/OData.d.ts" />
/// <reference path="../control/SpreadsheetDialog.d.ts" />
/// <reference path="../control/SpreadsheetDialog.gen.d.ts" />
/// <reference path="dialog/SpreadsheetUploadDialog.d.ts" />
declare module "cc/spreadsheetimporter/v1_1_1/controller/SpreadsheetUpload" {
    import ManagedObject from "sap/ui/base/ManagedObject";
    import Component from "cc/spreadsheetimporter/v1_1_1/Component";
    import XMLView from "sap/ui/core/mvc/XMLView";
    import { Messages, ListObject, ComponentData } from "cc/spreadsheetimporter/v1_1_1/types";
    ...
    import SpreadsheetDialog from "cc/spreadsheetimporter/v1_1_1/control/SpreadsheetDialog";
    import SpreadsheetUploadDialog from "cc/spreadsheetimporter/v1_1_1/controller/dialog/SpreadsheetUploadDialog";
    /**
